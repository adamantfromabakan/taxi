...
public class MainActivity extends Activity  /*implements LocationListener*/ implements android.view.View.OnClickListener {
    ...
    protected void onResume() {
        ...
        // ÔË ËÒÔÓÎ¸ÁÓ‚‡ÌËË ÒÂÚÂÈ ÚËÔ‡ GSM
	...
	public void onClickTaxi(View v) {
		rsltTXT.setText("Œ·‡·‡Ú˚‚‡ÂÏ ÍÓÏ‡Ì‰Û"+"\n");		
		 try
	        {
...
/////////////////
		        ...
		        orderdata.setText("ŒÊË‰‡ÂÚÒˇ Á‡„ÛÁÍ‡ Á‡ˇ‚ÓÍ,\n ‚ ÒÎÛ˜‡Â ÓÚÒÛÚ‚Ëˇ ‰‡ÌÌ˚ı Ó·‡ÚËÚÂÒ¸ Í ÔÓÒÚ‡‚˘ËÍÛ »ÌÚÂÌÂÚ");
...
/////////////////				
	...
	public void addRowOrders(TableLayout table, String cell1, String cell2, String cell3, String cell4, String cell5, String cell6, String cell7, String cell8, String cell9, String iffcell, int numOrder) {
        ...
        if (iffcell.length()<5) {
            ...
            if (cell6.trim().length()<1) {
            	Ordersbtn1.setText("”ÒÚ‡ÌÓ‚ËÚ¸ ‚ÂÏˇ ÔÓ‰‡˜Ë"); 
            } else {
            Ordersbtn1.setText("œÓ‰‡˜‡\n"+cell6); 
            }
            ...
            if (cell7.trim().length()<1) {
            	Ordersbtn2.setText("”ÒÚ‡ÌÓ‚ËÚ¸ ‚ÂÏˇ ÓÚ˙ÂÁ‰‡");
            } else {
            Ordersbtn2.setText("ŒÚ˙ÂÁ‰\n"+cell7);
            }
            ...
            if (cell8.trim().length()<1) {
            	Ordersbtn3.setText("”ÒÚ‡ÌÓ‚ËÚ¸ ‚ÂÏˇ ÔË·˚ÚËˇ");	
            } else {
            Ordersbtn3.setText("œË·˚ÚËÂ\n"+cell8);
            }
	...
	public void addshortcut(){
		...
		intentSC.putExtra(Intent.EXTRA_SHORTCUT_NAME, "“‡ÍÒË π1");
...
case Dialog.BUTTON_NEGATIVE:  break;    }  } };
	...
	@Override
		...
		//Toast.makeText(this, "«‡ˇ‚Í‡ π "+(j) , Toast.LENGTH_LONG).show();
			switch (i) {
		     case 106://¬–≈Ãﬂ
